...
from lightning_modules import MultiMetricModule, PredictionWriter
...
def run(raw_args=None):
    ...
    module = MultiMetricModule(model=model, optimizer=None, scheduler=None, train_loss=None, metric_dict=None, average_over_batch=use_sum_reduction)
